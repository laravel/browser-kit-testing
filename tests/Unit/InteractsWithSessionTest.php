...
class InteractsWithSessionTest extends TestCase
{
    ...
    public function session_method_can_add_data_on_session()
    {
        $this->app['session'] = new class {
            ...
            public function put() { return $this->put++;  }
...
/**
    ...
    public function can_start_session()
    {
        $this->app['session'] = new class {
            public $start = false;
            public function isStarted() { return $this->start; }
            public function start() { return $this->start = true; }
        };
    ...
    public function can_flush_session()
    {
        $this->app['session'] = new class {
            ...
            public function isStarted() { return true; }
            public function flush() { $this->flush = true; }
            public function isCalledFlushMethod() { return $this->flush; }
        };
    ...
    public function check_if_exists_errors_on_session()
    {
        $this->app['session'] = new class { };
        $this->app['session.store'] = new class {
            public function get($key) { return $this; }
            public function has($key) { return true; }
        };
